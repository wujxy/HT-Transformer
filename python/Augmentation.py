...
The expansion is done at preprocessing time: each expansion applies one random
SO(3) rotation to ALL events, generating a full rotated copy of the dataset.
"""
